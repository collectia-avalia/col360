      ...
      {studyResult && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            {/* KPI Cupo Sugerido */}
            <div className="border border-slate-200 rounded-xl p-3 sm:p-4 bg-indigo-50/30 flex flex-col justify-between overflow-hidden">
              <div>
            ...
            <div className="border border-slate-200 rounded-xl p-3 sm:p-4 bg-slate-50 flex flex-col justify-between overflow-hidden">
              <div>
                ...
                <p className="text-sm sm:text-base md:text-[11px] lg:text-sm xl:text-xl font-bold text-slate-800 mt-1 whitespace-nowrap leading-tight">
